...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/bower_components/bootstrapdatepicker/dist/css/bootstrap-datepicker.min.css">
    <link rel="stylesheet"
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url(); ?>" class="logo">
                ...
                <span class="logo-lg"><b>Vespa</b>Ari</span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="<?php echo base_url() . 'dashboard/Collection' ?>">
                            <i class="fa fa-th"></i>
